...
public class Step3 { // class start
    ...
    public static void main(String[] args) { // main()함수 // 실행시 필수! // m s
        ...
        int var4 = 0xB3;   // 16진수 : 데이터앞에 0x   B3[16] -> 179[10]
        ...
        //short s2 = -50000;
        //System.out.println("s2 : " + s2); 허용범위 벗어남.
            // java: incompatible types: possible lossy conversion from int to short

        // *int 타입 [ -21억 ~ 21억 ] : 4바이트 : !!! : 정수타입 리터럴(그 값 자체)
        int i1 = 2000000000;
        System.out.println("i1 : " + i1);
        //int i2 = 3000000000;
        //System.out.println("i2 : " + i2); 허용범위 벗어남.
        ...
        // [p.43] char [ 0 ~ 65535 ] : 2바이트 : !!! : ''작은따옴표 , 65536개의 문자 표현가능 , 부호[signed]/부호없음[unsigned]
        char c1 = 'A';
        ...
        double d1 = 0.12345678912345678901234567;
