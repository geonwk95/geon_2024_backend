...
public class Step2 {
    public static void main(String[] args) {
        ...
        try {
            ...
            // 2. 위에서 등록된 드라이버객체를 이용한 db연동(  jabc:mysql://ip주소:part번호/DB명 , 계정 , 비밀번호 )
            // * 예외처리 필수 : try{ }catch( 예외클래스명 매개변수 ){ } // SQLException
            // * 연동성공시 반환객체 : Connection 객체( statement ) 구현객체 생성, 트랜잭션처리 , DB연결 사용
