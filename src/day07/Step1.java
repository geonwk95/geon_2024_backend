    ...
    public static void main(String[] args) {
        ...
        /*          - 필드 : 객체의 상태
            ...
            - 객체 지향 프로그래밍의 특징
                    ...
                    3.다형성 : 사용방법(행위)는 동일하지만 실행 결과는 다양하게 나오는 성질
                            자동차(객체)
                                    - 전진 : 무료 타이어 객체(펑크) -------> 한국타이어 10만원
                                                                         한국타이어 객체 => 전진:무료타이어보다 조금더 부드럽다.
                                                                -------> 금호타이어 10만원
                                                                         금호타이어 객체 => 전진:무료타이어보다 많이 부드럽다.

            - 객체와 클래스
                        - 클래스 : (객체의설계도) 객체를 생성할려면 설계도 해당하는 클래스가 필요
                        - 인스턴스 : (힙이생성된객체) 클래스로부터 생성된 객체
            ...
            - 클래스 구성멤버
                    1. 필드 : 객체의 데이터를 저장하는 공간 * 형태가 변수와 비슷하지만 쓰임새는 다르다
                    2. 생성자 : 객체를 생성할 때 객체의 초기화 역할을 담당
                    3. 메소드 : 객체가 수행할 동작
         */
        ...
        // 3. 변수 생성한다( 생성된 객체의 주소를 담기 위해 )
            // 1. 타입( 담을 객체의 클래스와 동일 ) 2. 변수명( 첫글자 소문자 카멜 )
        // Student student ;
        // 4. 객체 주소를 변수에 담기
