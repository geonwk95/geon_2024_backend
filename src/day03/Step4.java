    ...
    public static void main(String[] args) { // main s
        ...
        Scanner scanner = new Scanner(System.in);
            // !!! : Scanner 클래스 입력시 [ 라이브러리 -> 호출 ]
                // 자동완성이 자동으로 클래스 위에 import java.util.Scanner; 확인
        ...
        }// 만약에 내가 입력한 값이 저장된 point 변수가 80보다 이상이면 (true) 출력문이 실행되고 (false) 아니면 실행 안된다.
        ...
        }// 만약에 내가 입력한 값이 저장된 point변수가 90보다 이상이면 (true) 합격출력 (false) 불합격출력
        ...
        // 4. 중첩 조건
        char sex = 'M';
        if( sex == 'M' || sex == 'W' ){ // 만약에 성별이 m(남자) 이면
