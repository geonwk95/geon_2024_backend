...
public class Step1 { // class s
    ...
    public static void main(String[] args) { // main s
        ...
        System.out.println(" 10 < x < 20 : " + ( x > 10 && x < 20));    // 그리고
        System.out.println(" y == 10 또는 y == 20 : " + ( y == 10 || y == 20)); // 또는
        System.out.println(" x >= 30 의 반대 : " + !( x >= 30 ));  // 부정/반대

        // 4. 증감연산자
        System.out.println(" x++ : " + (x++));  // 10 출력후 1증가
        System.out.println(" x : " + (x));  // 11
        System.out.println(" ++x : " + (++x)); // 1 더하기 하고 출력 // 12

        System.out.println(" x-- : " + (x--)); // 12 출력후 1감소
        System.out.println(" x : " + (x)); // 11
        System.out.println(" --x : " + (--x)); // 1 감소 후 출력 // 10

        // 5. (복합)대입연산자
        x = 30; // = 오른쪽 값을 왼쪽에 대입
        x += 10; // = x 에 10 더한후에 x에 결과 대입
        // -= , *= , /= , %=
        ...
        String 결과2 = x >= 90 ? "A등급" : x >= 80 ? "B등급" : x >= 60 ? "C등급" : "루저" ;
...
// 1. 변수 : 하나의 값을 저장하는 메모리 공간 , 1.타입 2.변수명 3.대입 4.초깃값
