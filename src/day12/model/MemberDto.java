...
// DTO : 데이터 이동 객체
    // - 복잡한 로직을 하는 곳이 아니다. 단순 데이터 이동
    // 1. 저장할 필드 선정 , 권장 private
    // 2. 생성자 ( 개발자 용도에 따라 선언 ) , 권장 : 기본생성자 , 풀생성자
    // 3. 메소드 ( 형변화 , 호출 ) 권장 : setter/getter , toString
public class MemberDto {
    ...
    // 오른쪽클릭 -> 생성 -> 생성자 -> 선택한 필드 만큼의 생성자를 자동으로 만들어줌
