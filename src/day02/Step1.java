package day02;  // 현재 클래스파일의 폴더위치 (패키지명)
...
public class Step1 { // 1.자바의 모든 코드는 클래스 안에서 작성. // class s
    ...
    public static void main(String[] args) { // 2.main()함수 : main스레드포함 // main s
        ...
        */
        ...
        // [p.55] 강제 타입 변환 = 캐스팅 = 상속 = 다형성[다양한형태의성질] 특징
...
;
        ...
        int v10 = 1;
        int v11 = 2;
        //int result7 = v10 / v11;  // 0    int / int => int [ 문제 없음 - 소수점 표현 불가능 ]
        double result7 = (double) v10 / v11;    // 0.5  int / int => (캐스팅) 해서 소수점 표현
